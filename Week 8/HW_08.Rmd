...
source_url(paste0("https://raw.githubusercontent.com/sophialiCMU/", 
                  "36-350/main/Week%208/dark_and_stormy.R"))
```
...
```{r linewidth=80}
source_url(paste0("https://raw.githubusercontent.com/sophialiCMU/36-350/",
                  "main/Week%208/dark_and_stormy.R"))
source_url(paste0("https://raw.githubusercontent.com/sophialiCMU/36-350/",
           "new_branch/Week%208/dark_and_stormy.R"))
```
...
test_that(desc = "Test for string of length greater than 1",expect_warning(f("aa")))
test_that(desc = "Test for vector of length > 1",           expect_error(f(c("a", "b"))))
test_that(desc = "Test for vector of length = 1",           expect_warning(f(c("ji"))))
...
f = function(letter) {
  ...
  if ( nchar(letter) > 1 ) warning("The input character should be of length 1.")
