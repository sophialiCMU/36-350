...
```
```
The p-value of the t teat is ~3.7*10^-13. This means that we should reject the null hypothesis because a p-value less than 0.05 indicates there is less than a 5% probabilty the null is correct. So we reject that the two libaries pull from the same population and publiation dates. 
