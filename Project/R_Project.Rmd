...
```{r linewidth=80}
file.edit$Patron.Group = as.factor(file.edit$Patron.Group)
pg = file.edit$Patron.Group

temp.df = data.frame(days.out = days.out, Patron.Group = file.edit$Patron.Group)
