...
# let = apply(data.frame(file.edit$LC.Classification.Top.Line), 1, FUN=substr, start=1, stop=1)  
# Q18.file.edit = data.frame(Classification = file.edit$LC.Classification.Top.Line,
#                            First = let)
